        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '订单时间', datafield: 'OrderTime', width: 150, align: 'center', cellsAlign: 'center' },
                    { text: '来客人数', datafield: 'VisitorsNumber', width: 150, align: 'center', cellsAlign: 'center' },
                    { text: '陪同人数', datafield: 'EscortNumber', width: 150, align: 'center', cellsAlign: 'center' },
                    { text: '人数合计', datafield: 'NumberCount', width: 150, align: 'center', cellsAlign: 'center' },
                    { text: '支付方式', datafield: 'VehicleType', width: 150, align: 'center', cellsAlign: 'center' },

        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '本月折旧额', datafield: 'PTD_DEPRECIATION', width: 150, align: 'center', cellsAlign: 'center' },
                    { text: 'YTD折旧', datafield: 'YTD_DEPRECIATION', width: 150, align: 'center', cellsAlign: 'center' },
                    { text: '累计折旧', datafield: 'ACCT_DEPRECIATION', width: 150, align: 'center', cellsAlign: 'center' },
                    ...
                    { text: '费用账户组合段1', datafield: 'EXP_ACCOUNT', width: 150, align: 'center', cellsAlign: 'center' },

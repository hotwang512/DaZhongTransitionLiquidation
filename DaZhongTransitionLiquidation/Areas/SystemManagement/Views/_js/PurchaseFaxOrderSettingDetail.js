...
var $page = function () {
    ...
    function addEvent() {
        ...
        $("#btnSave").on("click",
            function() {
                ...
                if (validateError <= 0) {
                    debugger;
                    $.ajax({
                        url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/SavePurchaseOrderSetting",
                        data: {
                            "VGUID": $("#VGUID").val(),
        ...
        $("#btnAddManagementCompany").on('click', function (event) {
            ...
            if (PurchaseOrderSettingVguid != null) {
                $.ajax({
                    url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/AddManagementCompany",
                    data: {
    ...
    function getOrderSettingInfoListDetail() {
        $.ajax({
            url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/GetPurchaseFaxOrderSettingDetail",
            data: {
                "vguid": $("#VGUID").val()
            },
            type: "post",
    ...
    function initSelectMinor() {
        var source =
        {
            ...
            url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/GetMinorListDatas",
            async: false
        };
    ...
    function initSelectPurchaseDepartment() {
        var source =
        {
            ...
            url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/GetPurchaseDepartmentListDatas",
            async: false
            };
            var dataAdapter = new $.jqx.dataAdapter(source);
    ...
    function initBusinessProject() {
        var url = "/Systemmanagement/PurchaseFaxOrderSettingDetail/GetBusinessProject";
        // prepare the data
        var source =
        {
            datatype: "json",
...
function GetManagementCompanyData_bak() {
    var source =
    {
        ...
        url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/GetBusiness_PurchaseDepartment"   //获取数据源的路径
    };
    ...
    var source =
        {
            ...
            url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/GetPurchaseManagementCompanyData"   //获取数据源的路径
        };
    var typeAdapter = new $.jqx.dataAdapter(source);
...
function DeleteManagementCompany(vguid, managementCompany) {
    ...
    if (PurchaseOrderSettingVguid != null) {
        $.ajax({
            url: "/Systemmanagement/PurchaseFaxOrderSettingDetail/DeleteManagementCompany",
            data: {
                "VGUID": vguid
            },
            type: "post",

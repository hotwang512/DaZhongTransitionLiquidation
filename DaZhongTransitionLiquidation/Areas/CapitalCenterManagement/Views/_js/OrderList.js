        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '业务类型', datafield: 'BusinessType', width: 250, align: 'center', cellsAlign: 'center' },
                    { text: '业务项目', datafield: 'BusinessProject', width: 250, align: 'center', cellsAlign: 'center' },
                    { text: '业务子项', datafield: 'BusinessSubItem', width: 250, align: 'center', cellsAlign: 'center', },
                    { text: '摘要', datafield: 'Abstract', width: 250, align: 'center', cellsAlign: 'center' },
                    { text: '金额', datafield: 'Money', cellsFormat: "d2", width: 250, align: 'center', cellsAlign: 'center' },

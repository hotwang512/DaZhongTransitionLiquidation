...
namespace DaZhongTransitionLiquidation.Areas.PaymentManagement.Controllers.SpareOne
{
    public class SpareOneController : BaseController
    {
        // GET: PaymentManagement/SpareOne
        public SpareOneController(DbService dbService, DbBusinessDataService dbBusinessDataService) : base(dbService, dbBusinessDataService)
        {
        ...
        public JsonResult SaveCompanySection(Business_SevenSection sevenSection, bool isEdit)
        {
            ...
            if (!isEdit)
            {
                ...
                sevenSection.SectionVGUID = "E63BD715-C27D-4C47-AB66-550309794D43";

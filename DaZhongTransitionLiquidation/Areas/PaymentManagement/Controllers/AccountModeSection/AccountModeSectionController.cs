...
namespace DaZhongTransitionLiquidation.Areas.PaymentManagement.Controllers.AccountModeSection
{
    public class AccountModeSectionController : BaseController
    {
        public AccountModeSectionController(DbService dbService, DbBusinessDataService dbBusinessDataService) : base(dbService, dbBusinessDataService)
        {

        }
        // GET: PaymentManagement/AccountModeSection
        ...
        public JsonResult GetCompanySection(GridParams para)
        {
            ...
            DbBusinessDataService.Command(db =>
            {
                ...
                jsonResult.Rows = db.Queryable<Business_SevenSection>().Where(x => x.SectionVGUID == "H63BD715-C27D-4C47-AB66-550309794D43")
        ...
        public JsonResult SaveCompanySection(Business_SevenSection sevenSection, bool isEdit)
        {
            ...
            if (!isEdit)
            {
                ...
                sevenSection.SectionVGUID = "H63BD715-C27D-4C47-AB66-550309794D43";
            ...
            DbBusinessDataService.Command(db =>
            {
                ...
                var result = db.Ado.UseTran(() =>
                {
                    ...
                    var isAny = db.Queryable<Business_SevenSection>().Any(x => x.Code == code && x.VGUID != guid && x.SectionVGUID == "H63BD715-C27D-4C47-AB66-550309794D43");
                    if (isAny)
                    {
                        IsSuccess = "2";
                        return;

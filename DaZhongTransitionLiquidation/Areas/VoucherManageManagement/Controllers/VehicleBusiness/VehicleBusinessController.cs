    ...
    public class VehicleBusinessController : BaseController
    {
        ...
        public JsonResult GeVehicleData(Business_VehicleUnitList searchParams, GridParams para)
        {
            ...
            DbBusinessDataService.Command(db =>
            {
                ...
                response = db.SqlQueryable<Business_VehicleUnitList>(@"select a.VGUID,a.ORIGINALID,a.YearMonth,a.PLATE_NUMBER,b.MODEL_MINOR,CAST(a.MODEL_DAYS AS decimal(18,2)) as MODEL_DAYS
                            ...
                            as b on a.PLATE_NUMBER = b.PLATE_NUMBER where b.OPERATING_STATE='在运' and b.GROUP_ID='出租车'  and b.MODEL_MAJOR is not null ")
       ...
       //                      --a.MODEL_MINOR,
       //                      CAST(a.MODEL_DAYS AS decimal(18,2)) as MODEL_DAYS

...
namespace DaZhongTransitionLiquidation.Areas.PaymentManagement.Controllers.SpareTwo
{
    public class SpareTwoController : BaseController
    {
        // GET: PaymentManagement/SpareTwo
        public SpareTwoController(DbService dbService, DbBusinessDataService dbBusinessDataService) : base(dbService, dbBusinessDataService)
        {
        ...
        public JsonResult GetCompanySection(string companyCode, string accountModeCode, GridParams para)
        {
            ...
            DbBusinessDataService.Command(db =>
            {
                ...
                jsonResult.Rows = db.Queryable<Business_SevenSection>().Where(x => x.SectionVGUID == "F63BD715-C27D-4C47-AB66-550309794D43" &&
        ...
        public JsonResult SaveCompanySection(Business_SevenSection sevenSection, bool isEdit)
        {
            ...
            if (!isEdit)
            {
                ...
                sevenSection.SectionVGUID = "F63BD715-C27D-4C47-AB66-550309794D43";
            ...
            DbBusinessDataService.Command(db =>
            {
                ...
                var result = db.Ado.UseTran(() =>
                {
                    ...
                    var isAny = db.Queryable<Business_SevenSection>().Any(x => x.Code == code && x.AccountModeCode == sevenSection.AccountModeCode && x.CompanyCode == sevenSection.CompanyCode && x.VGUID != guid && x.SectionVGUID == "F63BD715-C27D-4C47-AB66-550309794D43");
                    if (isAny)
                    {
                        IsSuccess = "2";
                        return;

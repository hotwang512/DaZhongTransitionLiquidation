        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '业务类型', datafield: 'BusinessType', width: 200, pinned: true, align: 'center', cellsAlign: 'center', hidden: true },
                    { text: '业务项目', datafield: 'BusinessProject', width: 200, pinned: true, align: 'center', cellsAlign: 'center', hidden: true },
                    { text: '业务子项1', datafield: 'BusinessSubItem1', width: 200, pinned: true, align: 'center', cellsAlign: 'center', hidden: true },
                    { text: '业务子项2', datafield: 'BusinessSubItem2', width: 200, align: 'center', cellsAlign: 'center', hidden: true },
                    { text: '业务子项3', datafield: 'BusinessSubItem3', width: 200, align: 'center', cellsAlign: 'center', hidden: true },
                    { text: '订单日期', datafield: 'OrderDate', width: 200, align: 'center', cellsAlign: 'center' },
                    { text: '订单时间', datafield: 'OrderTime', width: 200, align: 'center', cellsAlign: 'center' },
                    { text: '对方单位名称', datafield: 'PaymentCompany', width: 200, align: 'center', cellsAlign: 'center' },
                    { text: '来客人数', datafield: 'VisitorsNumber', width: 200, align: 'center', cellsAlign: 'center' },
                    { text: '陪同人数', datafield: 'EscortNumber', width: 200, align: 'center', cellsAlign: 'center' },
                    { text: '人数合计', datafield: 'NumberCount', width: 200, align: 'center', cellsAlign: 'center' },
                    { text: '支付方式', datafield: 'PaymentMethod', width: 200, align: 'center', cellsAlign: 'center' },

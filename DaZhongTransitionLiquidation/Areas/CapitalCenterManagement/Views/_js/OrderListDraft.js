        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '业务类型', datafield: 'BusinessType', width: 200, pinned: true, align: 'center', cellsAlign: 'center' },
                    { text: '业务项目', datafield: 'BusinessProject', width: 200, pinned: true, align: 'center', cellsAlign: 'center' },
                    { text: '业务子项1', datafield: 'BusinessSubItem1', width: 200, pinned: true, align: 'center', cellsAlign: 'center', },

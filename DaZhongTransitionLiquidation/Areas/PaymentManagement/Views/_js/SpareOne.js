...
var $page = function () {
    ...
    function addEvent() {
        ...
        selector.$AddNewBankData_OKButton().on("click", function () {
            ...
            if (validateError <= 0) {
                $.ajax({
                    url: "/PaymentManagement/SpareOne/SaveCompanySection?isEdit=" + isEdit,
                    data: {
    ...
    function dele() {
        ...
        $.ajax({
            url: "/PaymentManagement/SpareOne/DeleteCompanySection",

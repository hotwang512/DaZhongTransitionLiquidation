        ...
        k.prototype = {
            ...
            update: function () {
                ...
                return arguments.length ? (a.each(arguments, a.proxy(function (a, b) {
                    ...
                    d ? (this.setValue(), this.element.change()) : this.dates.length && ("string" == typeof this.o.format ? (String(this.element[0].value).length === String(this.o.format).length && String(b) !== String(this.dates) && this._trigger("changeDate"), this.element.change()) : String(b) !== String(this.dates) && (this._trigger("changeDate"), this.element.change())),
                    ...
                    for (var u, v, w = []; p.valueOf() < t;) {
                        ...
                        v = this.getClassNames(p),
                            ...
                            this.o.beforeShowDay !== a.noop && (e = this.o.beforeShowDay(this._utc_to_local(p)), e === b ? e = {} : "boolean" == typeof e ? e = {
                                ...
                                classes: e
                            }), e.enabled === !1 && v.push("disabled"), e.classes && (v = v.concat(e.classes.split(/\s+/))), e.tooltip && (d = e.tooltip)),
                ...
                if (!this.updating) {
                    ...
                    if (d !== b) {
                        ...
                        if (- 1 !== g) {
                            ...
                            else if (e > this.dates[i]) for (; j > i && e > this.dates[i];) this.pickers[i++].setUTCDate(e);
                            this.updateDates(),

...
var $page = function () {
    ...
    function addEvent() {
        ...
        selector.$btnAdd().on("click", function () {
            ...
            isEdit = false;
            vguid = "";
            $("#myModalLabel_title").text("新增成本中心段");
        ...
        selector.$AddNewBankData_OKButton().on("click", function () {
            ...
            if (validateError <= 0) {
                $.ajax({
                    url: "/PaymentManagement/CostCenterSection/SaveCompanySection?isEdit=" + isEdit,
                    data: {
        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '编码', datafield: 'Code', width: 800, align: 'center', cellsAlign: 'center', cellsRenderer: detailFunc },
                    { text: '描述', datafield: 'Descrption', width: 840, align: 'center', cellsAlign: 'center' },
    ...
    function dele() {
        ...
        $.ajax({
            url: "/PaymentManagement/CostCenterSection/DeleteCompanySection",
...
function edit(guid, Code, Descrption) {
    ...
    $("#myModalLabel_title").text("编辑成本中心段");

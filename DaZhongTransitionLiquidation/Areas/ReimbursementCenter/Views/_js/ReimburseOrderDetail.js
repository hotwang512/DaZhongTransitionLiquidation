...
var $page = function () {
    ...
    function addEvent() {
        ...
        $("#btnSave").on("click",
            function () {
                ...
                if (validateError <= 0) {
                    ...
                    debugger;
                    $.ajax({
                        url: "/ReimbursementCenter/ReimburseOrderDetail/SaveFixedAssetsOrder",
                        data: {
                            "VGUID": $("#VGUID").val(),
        ...
        $("#Upload_OKBtn").on("click", function () {
            ...
            if ($("#devPhoto").attr("src") != undefined) {
                layer.load();
                $.ajax({
                    url: "/ReimbursementCenter/ReimburseOrderDetail/UploadToImageServer",
                    data: {
                        "Vguid": $("#VGUID").val(),
        ...
        $("#btnSubmit").on("click",
            function () {
                $.post("/ReimbursementCenter/ReimburseOrderDetail/SubmitFixedAssetsOrder", { vguid: $("#VGUID").val() }, function (msg) {
                    switch (msg.Status) {
                        case "0":
        ...
        $('#PaymentInformation').on('select', function (event) {
            ...
            if (args) {
                ...
                $.post("/ReimbursementCenter/ReimburseOrderDetail/GetCustomerBankInfo", { vguid: item.value }, function (msg) {
        ...
        $('#PayCompanyDropdown').on('select', function (event) {
            ...
            if (args && $("#PayMode").val() != "现金") {
                ...
                $.post("/ReimbursementCenter/ReimburseOrderDetail/GetCompanyBankInfo",
    ...
    function GetCompanyBankInfoDropdownByCode() {
        debugger;
        var url = "/ReimbursementCenter/ReimburseOrderDetail/GetCompanyBankInfoDropdownByCode";
        var source =
        {
            datatype: "json",
            datafields: [
    ...
    function getFixedAssetsOrderDetail() {
        $.post("/ReimbursementCenter/ReimburseOrderDetail/GetFixedAssetsOrder", { vguid: $("#VGUID").val() }, function (msg) {
    ...
    $("#ContractFileInput").on("change", function () {
        ...
        if (!checkFileExt(fileExt)) {
            ...
            $("#contractFormFile").ajaxSubmit({
                url: "/ReimbursementCenter/ReimburseOrderDetail/UploadContractFile",
                type: "post",
                data: {
                    'Vguid': $("#VGUID").val()
                },
    ...
    $("#FileInput").on("change",
        function () {
            ...
            if (!checkFileExt(fileExt)) {
                ...
                layer.load();
                $("#formFile").ajaxSubmit({
                    url: "/ReimbursementCenter/ReimburseOrderDetail/UploadLocalFile",
                    type: "post",
                    data: {
        ...
        function () {
            ...
            if (!checkFileExt(fileExt)) {
                ...
                $("#localFormFile").ajaxSubmit({
                    url: "/ReimbursementCenter/ReimburseOrderDetail/AllUploadLocalFile",
                    type: "post",
                    data: {
                        'Vguid': $("#VGUID").val(),
                        'AttachmentType': $("#AttachmentType").val()
...
function PendingPaymentAttachmentUpload() {
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/PendingPaymentAttachmentUpload",
...
//{
//    $.ajax({
//        url: "/ReimbursementCenter/ReimburseOrderDetail/GetUseDepartment",
//        data: {},
//        type: "POST",
//        dataType: "json",
//        async: false,
...
function initPaymentInformationComboBox() {
    //付款单位及相关账户信息
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/GetCustomerBankInfoList",
        data: { "PurchaseOrderSetting": $("#PurchaseGoods").val() },
        type: "POST",
        dataType: "json",
        async: false,
        success: function (data) {
            ...
            $.post("/ReimbursementCenter/ReimburseOrderDetail/GetCustomerBankInfo", { vguid: $("#PaymentInformation").val() }, function (msg) {
                $("#BankAccountName").val(msg.BankAccountName);
                $("#BankAccount").val(msg.BankAccount);
                $("#Bank").val(msg.Bank);
                $("#BankNo").val(msg.BankNo);
...
function initSelectPurchaseGoods(PurchaseDepartment) {
    //使用部门
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/GetPurchaseGoods",
...
function initSelectGoodsModel(Goods) {
    //物品类型
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/GetGoodsModelDropDown",
        data: { "Goods": Goods },
        type: "POST",
        dataType: "json",
        async: false,
...
function initTable() {
    ...
    var source =
    {
        ...
        updaterow: function (rowid, rowdata, commit) {
            $.ajax({
                url: "/ReimbursementCenter/ReimburseOrderDetail/UpdateAssetNum",
...
function getDetailData() {
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/GetAssetOrderDetails",
...
function deleteApprovalFile(vguid) {
    ...
    //删除文件
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/DeleteApprovalFile",
        data: { vguid: vguid },
        async: false,
        type: "post",
        success: function (msg) {
...
function getAttachment() {
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/GetAttachmentInfo",
        data: {
            "VGUID": $("#VGUID").val()
        },
        type: "post",
...
function delAttachment(delID) {
    $.ajax({
        url: "/ReimbursementCenter/ReimburseOrderDetail/DeleteAttachment",
        data: { VGUID: delID },
        traditional: true,
        type: "post",
        success: function (msg) {

...
var $page = function () {
    ...
    function addEvent() {
        ...
        $("#btnAdd").on("click", function () {
            window.location.href = "/Systemmanagement/PurchaseFaxOrderSettingDetail/Index";
        ...
        $("#BankInfoDialog_OKBtn").on("click", function () {
            ...
            if (selection.length < 1) {
                ...
                debugger;
                $.ajax({
                    url: "/Systemmanagement/PurchaseFaxOrderSetting/SetPurchaseSupplier",
        ...
        var source =
            {
                ...
                url: "/Systemmanagement/PurchaseFaxOrderSetting/GetCustomerBankInfo"   //获取数据源的路径
            };
    ...
    function dele(selection) {
        $.ajax({
            url: "/Systemmanagement/PurchaseFaxOrderSetting/DeletePurchaseOrderSetting",
    ...
    function initTable() {
        var source =
            {
                ...
                url: "/Systemmanagement/PurchaseFaxOrderSetting/GetPurchaseFaxOrderSettingListDatas"   //获取数据源的路径
            };
        var typeAdapter = new $.jqx.dataAdapter(source, {
            downloadComplete: function (data) {
                source.totalrecords = data.TotalRows;
        ...
        selector.$grid().jqxDataTable(
            {
                ...
                columns: [
                    ...
                    { text: '税费名称', datafield: 'PurchaseGoods', width: 200, align: 'center', cellsAlign: 'center' },
        ...
        selector.$grid().on('rowDoubleClick', function (event) {
            ...
            var row = args.row;
            // row index.
            window.location.href = "/Systemmanagement/PurchaseFaxOrderSettingDetail/Index?VGUID=" + row.VGUID;
        });
    }
    ...
    var source =
            {
                ...
                id: "VGUID",
                data: { "VGUID": vguid },
                url: "/Systemmanagement/PurchaseFaxOrderSetting/GetPurchaseSupplierListDatas"   //获取数据源的路径
            };
    var typeAdapter = new $.jqx.dataAdapter(source, {
        downloadComplete: function (data) {
            source.totalrecords = data.TotalRows;
    ...
    var source =
            {
                ...
                id: "VGUID",
                data: { "VGUID": vguid },
                url: "/Systemmanagement/PurchaseFaxOrderSetting/GetDepartmentListDatas"   //获取数据源的路径
            };
    var typeAdapter = new $.jqx.dataAdapter(source, {
        downloadComplete: function (data) {
            source.totalrecords = data.TotalRows;
...
function InitBankCategorySelect() {
    ...
    var url = "/Systemmanagement/PurchaseFaxOrderSetting/GetBankCategoryListDatas";
    // prepare the data
    var source =
    {
        datatype: "json",
